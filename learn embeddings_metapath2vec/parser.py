...
def parameter_parser():
    ...
    parser.add_argument('--idx_metapath', default="M17", type=str)
    # combination of metapaths?
    parser.add_argument('--which_metapath', default="CHNHC+NHCHN+RandWalk", type=str)
    # how many repeated 'walks' per node
    ...
    #  M17-metapath_CHNHC+NHCHN+RandWalk-whichmeta_100-num_walks_50-len_metapath
    #  {}{}-metapath_{}-whichmeta_{}-num_walks_{}-len_metapath.txt"
    # CSP Layer
